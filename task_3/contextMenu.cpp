...
void getInfo()
{
    ...
    std::cout << "\nПрограмму сделал -- Филимонов Филипп.\n"
        << "Программа создает массив из элементов, которое имеют четные значениия,\n"
        << "расположенных на главной диагонали матрицы. Выводит этот массив и их произведение." << std::endl;
}
